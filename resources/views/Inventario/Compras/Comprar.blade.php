...
<div class="nav-tabs-custom">
	<div class="nav nav-tabs pull-right">
		<li class="pull-left header">Compras</li>
		<li><a href="/Compras/Devolver">Devolver</a></li>
		<li class="active"><a href="/Compras/Comprar" data-toggle="tab">Comprar</a></li>
	</div>
	<div class="tab-content">
			...
			<div class="dataTables_wrapper form-inline" role="grid">
				<table class="table table-bordered">
					...
					<tbody>
						...
						@include('Inventario.Compras.EditarCostoMob')
						@endforeach
					</tbody>
				</table>
			</div>
			...
			<div class="dataTables_wrapper form-inline" role="grid">
				<table class="table table-bordered">
					...
					<tbody>
						...
						@include('Inventario.Compras.EditarCostoCos')
						@endforeach
					</tbody>
				</table>
			</div>
			...
			<div class="dataTables_wrapper form-inline" role="grid">
				<table class="table table-bordered">
					...
					<tbody>
						...
						@include('Inventario.Compras.EditarCostoBot')
						@endforeach
					</tbody>
				</table>
			</div>
		...
		<a href="#" data-target="#dialogo-agregar-proveedor" data-toggle="modal" class="btn btn-success">Comprar: ${{$Total}}</a>
	</div>
	...
	@include('Inventario.Compras.AgregarProveedor')
