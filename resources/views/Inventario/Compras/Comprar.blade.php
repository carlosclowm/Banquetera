...
<div class="nav-tabs-custom">
  <div class="nav nav-tabs pull-right">
    <li class="pull-left header">Comprar</li>
    <li><a href="/Compras/Devolver">Devolver</a></li>
    <li class="active"><a href="/Compras/Comprar">Comprar</a></li>
  </div>
  <div class="tab-content">
    @if (count($errors)>0)
      ...
      <hr>
      <a href="#" data-target="#dialogo-agregar-proveedor" data-toggle="modal" class="btn btn-success" id="btnComprar">Comprar: $<?= number_format($Total) ?></a>
    </div>
...
<script type="text/javascript">
            ...
            function SumaTotal(costo, cantidad){
              ...
              document.getElementById('btnComprar').innerText = "Comprar: $"+AllTota.toLocaleString('de-DE');
            }
