...
<div class="nav-tabs-custom">
	<div class="nav nav-tabs pull-right">
		<li class="pull-left header">Devolver Venta</li>
		<li><a href="/Ventas/Cotizar">Cotizar</a></li>
		<li class="active"><a href="/Ventas/Devolver">Devolver</a></li>
  ...
  <div class="tab-content">
      ...
      <hr>
  		...
  		@endif
			...
			<hr>
			<a href="#" data-target="#dialogo-agregar-cliente" data-toggle="modal" class="btn btn-success">Devolver: ${{$Total}}</a>
    </div>
    ...
    @include('Inventario.Ventas.AgregarBotella')
		@include('Inventario.Ventas.AgregarClienteDev')
</div>
@endsection
