...
<div class="nav-tabs-custom">
  <div class="nav nav-tabs pull-right">
    ...
    <li class="active"><a href="/Ventas/Cotizar">Cotizar</a></li>
    <li><a href="/Ventas/Devolver">Devolver</a></li>
    <li><a href="/Ventas/Vender">Vender</a></li>
  </div>
  <div class="tab-content">
    @if (count($errors)>0)
      ...
      <hr>
      <a href="#" data-target="#dialogo-agregar-cliente-cot" data-toggle="modal" class="btn btn-success" id="btnCotizar">Cotizar: ${{$Total}}</a>
    </div>
    @include('Inventario.Ventas.AgregarClienteCot')
...
<script type="text/javascript">
            ...
            function SumaTotal(costo, cantidad){
              ...
              document.getElementById('btnCotizar').innerText = "Cotizar: $"+AllTota.toLocaleString('de-DE');
            }
            ...
            function CargarTotal(id){
              ...
              Producto.forEach(function(row){
                if(row['id_botella'] == id || row['id_cocina'] == id || row['id_mob'] == id){
                  ...
                  TotalUnit = row['costo'] * document.getElementById('cantidad').value;
