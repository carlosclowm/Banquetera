<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="dialogo-razon-{{$cli->id_cliente}}">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        ...
        {!!Form::open(array('url'=>'Ventas/Devolver/Venta','method'=>'POST','autocomplete'=>'off'))!!}
        {{Form::token()}}
