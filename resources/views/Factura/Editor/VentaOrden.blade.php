...
@section('contenido')
    <section class="content invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                ...
                                <a href="/Mover/Venta/PorCobrar/{{$Compra->id_ventas}}" class="btn btn-danger"> Mover a Por Cobrar</a>
                            </h2>
                        </div><!-- /.col -->
                    </div>
                    <!-- info row -->
                              ...
                              <script type="text/javascript">
			                	...
			                	function PutMobiliario($id, $Factura){
									...
									$.ajax({
					                    ...
					                    url: '/Orden/GetTotalVendido/'+'<?= $Compra->id_ventas ?>',
					                    dataType: 'json',
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <a href="/Orden/{{$Compra->id_ventas}}"><button class="btn btn-default"><i class="fa fa-times"></i> Salir</button></a>
